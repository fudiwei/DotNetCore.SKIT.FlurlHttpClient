...
namespace System.Text.Json.Converters.Common
{
    ...
    public abstract partial class TextualNumberArrayWithSplitConverterBase : JsonConverterFactory
    {
        ...
        {
            return new InternalTextualNumberArrayWithSplitConverter(Separator);
        }
    }

    partial class TextualNumberArrayWithSplitConverterBase
    {
        private sealed class InternalTextualNumberArrayWithSplitConverter : JsonConverter<object?>
        {
