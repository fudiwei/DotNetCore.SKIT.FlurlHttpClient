...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases
{
    public class TestCase_JsonConverterOfStringifiedStringListWithPipeSplitTest
    {
        ...
        [Test(Description = "测试用例：自定义 Newtosoft.Json.JsonConverter 之 TextualStringListWithPipeSplitConverter")]
        ...
        [Test(Description = "测试用例：自定义 System.Text.Json.Serialization.JsonConverter 之 TextualStringListWithPipeSplitConverter")]
