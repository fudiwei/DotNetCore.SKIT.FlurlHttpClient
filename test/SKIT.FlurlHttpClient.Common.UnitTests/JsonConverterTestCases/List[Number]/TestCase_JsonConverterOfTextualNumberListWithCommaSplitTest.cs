...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfTextualNumberListWithCommaSplitTest
    {
        private sealed class MockObject
        {
            [Newtonsoft.Json.JsonProperty(nameof(PropertyAsByte), Order = 101)]
            [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.Common.TextualNumberListWithCommaSplitConverter))]
            [System.Text.Json.Serialization.JsonPropertyOrder(101)]
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Converters.Common.TextualNumberListWithCommaSplitConverter))]
        ...
        [Test(Description = "测试用例：自定义 Newtosoft.Json.JsonConverter 之 TextualNumberListWithCommaSplitConverter")]
        ...
        [Test(Description = "测试用例：自定义 System.Text.Json.Serialization.JsonConverter 之 TextualNumberListWithCommaSplitConverter")]
