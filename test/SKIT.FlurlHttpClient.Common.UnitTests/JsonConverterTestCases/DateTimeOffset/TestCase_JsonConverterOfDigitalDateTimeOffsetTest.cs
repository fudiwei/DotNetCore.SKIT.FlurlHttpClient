...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfDigitalDateTimeOffsetTest
    {
        private sealed class MockObject
        {
            ...
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Converters.Common.DigitalDateTimeOffsetConverter))]
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.AreEqual("{\"Property\":\"20060102150405\"}", actualJson1);
            ...
            Assert.AreEqual("{\"Property\":\"20060102150405\",\"NullableProperty\":\"20060102150405\"}", actualJson2);
