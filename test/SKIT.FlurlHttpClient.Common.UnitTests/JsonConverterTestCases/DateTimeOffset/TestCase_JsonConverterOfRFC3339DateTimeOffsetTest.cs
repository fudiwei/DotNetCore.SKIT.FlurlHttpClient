    ...
    public class TestCase_JsonConverterOfRfc3339DateTimeOffsetTest
    {
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":\"2006-01-02T15:04:05+08:00\"}"));
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":\"2006-01-02T15:04:05+08:00\",\"NullableProperty\":\"2006-01-02T15:04:05+08:00\"}"));
