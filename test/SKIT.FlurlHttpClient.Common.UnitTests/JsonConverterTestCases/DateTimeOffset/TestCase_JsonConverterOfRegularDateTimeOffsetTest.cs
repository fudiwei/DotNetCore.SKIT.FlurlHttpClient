...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfRegularDateTimeOffsetTest
    {
        private sealed class MockObject
        {
            [Newtonsoft.Json.JsonProperty(nameof(Property), Order = 1)]
            [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.Common.RegularDateTimeOffsetConverter))]
            [System.Text.Json.Serialization.JsonPropertyOrder(1)]
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Converters.Common.RegularDateTimeOffsetConverter))]
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.AreEqual("{\"Property\":\"2006-01-02 15:04:05\"}", actualJson1);
            ...
            Assert.AreEqual("{\"Property\":\"2006-01-02 15:04:05\",\"NullableProperty\":\"2006-01-02 15:04:05\"}", actualJson2);
