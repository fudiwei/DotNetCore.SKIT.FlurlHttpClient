...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases
{
    ...
    public class TestCase_JsonConverterOfDigitalTimeOnlyTest
    {
        private sealed class MockObject
        {
            ...
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.Common.DigitalTimeOnlyConverter))]
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":\"150405\"}"));
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":\"150405\",\"NullableProperty\":\"150405\"}"));
