...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfStringifiedStringArrayWithPipeSplitTest
    {
        private sealed class MockObject
        {
            ...
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Converters.Common.StringifiedStringArrayWithPipeSplitConverter))]
        ...
        [Test(Description = "测试用例：自定义 Newtosoft.Json.JsonConverter 之 TextualStringArrayWithPipeSplitConverter")]
        ...
        [Test(Description = "测试用例：自定义 System.Text.Json.Serialization.JsonConverter 之 TextualStringArrayWithPipeSplitConverter")]
