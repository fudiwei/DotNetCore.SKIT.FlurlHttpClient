...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfRegularDateOnlyTest
    {
        private sealed class MockObject
        {
            [Newtonsoft.Json.JsonProperty(nameof(Property), Order = 1)]
            [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.Common.RegularDateOnlyConverter))]
            [System.Text.Json.Serialization.JsonPropertyOrder(1)]
            [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Converters.Common.RegularDateOnlyConverter))]
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.AreEqual("{\"Property\":\"2006-01-02\"}", actualJson1);
            ...
            Assert.AreEqual("{\"Property\":\"2006-01-02\",\"NullableProperty\":\"2006-01-02\"}", actualJson2);
