...
{
    public class TestCase_JsonConverterOfTextualBooleanReadOnlyTest
    {
        ...
        [Test(Description = "测试用例：自定义 System.Text.Json.Serialization.JsonConverter 之 TextualBooleanReadOnlyConverter")]
