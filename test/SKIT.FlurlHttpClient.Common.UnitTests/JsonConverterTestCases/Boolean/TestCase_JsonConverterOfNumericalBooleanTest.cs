...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases.JsonConverter
{
    ...
    public class TestCase_JsonConverterOfNumericalBooleanTest
    {
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            ...
            Assert.AreEqual("{\"Property\":0}", actualJson1);
            ...
            Assert.AreEqual("{\"Property\":0,\"NullableProperty\":0}", actualJson2);
            ...
            Assert.AreEqual("{\"Property\":1,\"NullableProperty\":1}", actualJson3);
