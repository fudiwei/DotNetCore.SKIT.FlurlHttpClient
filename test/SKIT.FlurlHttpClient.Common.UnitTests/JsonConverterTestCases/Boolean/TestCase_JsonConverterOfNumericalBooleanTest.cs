...
namespace SKIT.FlurlHttpClient.UnitTests.TestCases
{
    ...
    public class TestCase_JsonConverterOfNumericalBooleanTest
    {
        ...
        private static void TestCustomJsonConverter(IJsonSerializer jsonSerializer)
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":0}"));
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":0,\"NullableProperty\":0}"));
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(actualJson, Is.EqualTo("{\"Property\":1,\"NullableProperty\":1}"));
        ...
        [Test(Description = "测试用例：自定义 Newtosoft.Json.JsonConverter 之 NumericalBooleanConverter")]
        ...
        [Test(Description = "测试用例：自定义 System.Text.Json.Serialization.JsonConverter 之 NumericalBooleanConverter")]
